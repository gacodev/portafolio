...
export const descriptionTranslations = {
  ...
  pt: {
    'Plataforma IoT para gestión de tráfico inteligente con edge computing': 'Plataforma IoT para gestão de tráfego inteligente com edge computing',
    'Plataforma de movilidad urbana con seguimiento en tiempo real y optimización de rutas': 'Plataforma de mobilidade urbana com rastreamento em tempo real e otimização de rotas',
    'Sistema de rastreo GPS empresarial con análisis predictivo y geofencing': 'Sistema de rastreamento GPS empresarial com análise preditiva e geofencing',
    'Plataforma de análisis de huella de carbono con IA para empresas sostenibles': 'Plataforma de análise de pegada de carbono com IA para empresas sustentáveis',
    'Plataforma de gestión de talento humano con análisis de desempeño y bienestar': 'Plataforma de gestão de talentos com análise de desempenho e bem-estar',
    'Sistema de georeferenciación y mapeo con análisis espacial avanzado': 'Sistema de georeferenciamento e mapeamento com análise espacial avançada',
    'Sistema de gestión energética para optimización de consumo industrial': 'Sistema de gestão energética para otimização de consumo industrial',
    'Plataforma de machine learning para análisis predictivo y procesamiento de datos': 'Plataforma de machine learning para análise preditiva e processamento de dados'
  }
};
...
export const metricsTranslations = {
  ...
  pt: {
    projectPerformance: 'Desempenho de Projetos e Saúde Operacional',
    incidents: 'INCIDENTES',
    visitDashboard: 'Ver Dashboard',
    availability: 'DISPONIBILIDADE',
    sloMetrics: 'Métricas de SLO',
    incidentResponse: 'Resposta a Incidentes',
    devOpsEfficiency: 'Eficiência DevOps',
    ...
    minutes: 'minutos',
    apdexScore: 'Pontuação Apdex',
    monitorChecks: 'Monitores Ativos',
    alertsTriggered: 'Alertas Disparados',
    autoResolved: 'Auto-resolvidos',
    deployPerWeek: 'Implantações/Semana',
    leadTime: 'Tempo de Entrega',
    hours: 'horas',
    rollbacks: 'Reversões',
    errorBudget: 'Orçamento de Erro Restante',
    vulnerabilities: 'Vulnerabilidades',
    compliance: 'Pontuação de Conformidade',
    costTrend: 'Tendência de Custos',
    optimizationScore: 'Pontuação de Otimização',
    monthlyCost: 'Custo Mensal',
    latency: 'SLO de Latência',
    critical: 'Críticas',
    high: 'Altas',
    medium: 'Médias',
    year: 'Desde',
    ...
    slo_title: 'Service Level Objectives (SLOs)',
    slo_availability: 'Disponibilidade do Sistema',
    slo_latency: 'Performance de Latência',
    slo_error_budget: 'Error Budget Restante',
    incidents_title: 'Gestão de Incidentes',
    incidents_mttr: 'MTTR Médio',
    devops_title: 'Eficiência DevOps',
    devops_deployments: 'IMPLANTAÇÕES',
    devops_lead_time: 'Lead Time',
    monitoring_title: 'Monitoramento e Observabilidade',
    monitoring_checks: 'MONITORES',
    monitoring_apdex: 'APDEX SCORE',
    monitoring_auto_resolution_rate: 'Taxa de Auto-resolução',
    security_title: 'Segurança e Compliance',
    security_compliance: 'Compliance',
    security_critical: 'Críticas',
    security_high: 'Altas',
    security_medium: 'Médias',
    cost_title: 'Gestão de Custos',
